...
EOF
  ...
  echo "    git checkout -b hello-from-\$(hostname)"
  echo "    echo \"checked in from \$(hostname)\" >> setup/machines.txt"
  echo "    git commit -am \"Say hello from \$(hostname)\" && git push -u origin HEAD"
